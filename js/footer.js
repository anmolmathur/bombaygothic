              ...
              <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center md:text-left">
                  ...
                  <div>
                      ...
                      <nav class="flex flex-col space-y-3 font-raleway font-extralight">
                          ...
                          <a href="journal.html" class="text-gray-600 hover:text-brand-terracotta">journal</a>
                  ...
                  <div>
                      ...
                      <nav class="flex flex-col space-y-3 font-raleway font-extralight">
                          <a href="contact.html" class="text-gray-600 hover:text-brand-terracotta">contact us</a>
